...
devices = dict(
    ...
    sr2=device(
        ...
        move_x='robot_pos', move_z='robot_vert',
        adjust1='driver1_2_adjust', approach1='driver1_1_approach', hex_state1='driver1_1_hex_state',
        adjust2='driver1_1_adjust', approach2='driver1_2_approach', hex_state2='driver1_2_hex_state',
        unit='Item/Group'
    ),
    sm2=device(
